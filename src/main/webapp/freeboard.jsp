...
<div class="s-content sb"> 
 ...
 <div class="s-text">
  ...
  <form action="boardwrite-action.jsp" class ="text3" method="POST" enctype="multipart/form-data">
  <p><label class="s-label">제목</label></p>
  <input class="s-input" maxlength="256" type="text" name="title" placeholder="제목을 입력해주세요"></p>

  <p><label  class="s-label">파일첨부</label></p>
  <p><input class="s-input" type="file" name="uploadFile"></p>

  <p><label  class="s-label">문의내용</label></p>
  <p><textarea class="s-input" id="text" name="content" placeholder="문의 내용을 입력해주세요"></textarea></p>
